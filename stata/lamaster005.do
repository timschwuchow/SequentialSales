// Copyright 2011-2013 Timothy Schwuchow
...
global datdir 			"/afs/econ/data/bayerp/tim/condo/data/"
global progdir 			"/afs/econ/data/bayerp/tim/condo/${version}/"
global logdir 			"/afs/econ/data/bayerp/tim/condo/${version}/logs/"
global dataoutdir 		"${progdir}dataout/"
...
qui timer list 2
loc t2min=`r(t2)' / 60.0
!echo "`filename' finished in `t2min' seconds" | mail -s "`filename' finished running in `t2min' seconds" tjs24@duke.edu
!rm statasub.o* *.log
timer clear 2