...
//
// program 			-	chiprepxxx.do	-	Basic setup for LA dataset
//
// output			-	${datadir}chinoincludexxx.dta	-	non-target observations
// 					-	${datadir}chiincludexxx.dta		-	target observations


local filename chiprep${version}
...
//////////////////////////////////
{
	...
	compress
	save ${datdir}chinoinclude${version}.dta, replace
	restore
...
{
	compress
	save ${datdir}chiinclude${version}.dta, replace
}
