...
///////////////////////////////////
{
	...
	rename sr_loan_val_1 loan1
	rename sr_loan_val_2 loan2
	rename sr_loan_val_3 loan3
	...
	label variable loan1 "Value of first loan"
	label variable loan2 "Value of second loan"
	label variable loan3 "Value of third loan"
	...
	// replace loan1 		= 	0 if loan1 == .
	// replace loan2 		= 	0 if loan2 == .
	// replace loan3 		= 	0 if loan3 == .
	gen totloan 		= 	loan1 + loan2 + loan3
}
...
/////////////////////////////////////
{
	...
	bysort property_id (selldate obnum): gen isfirst 		= 	(_n == 1) 	// Flag first sale observed
...
///////////////////////////////////////
{
	...
	egen sellerexabb 	= 	soundex(lsellerabbnonum)
	...
	egen sellerex		=	soundex(lsellernonum)
	la var sellerex "Unabbreviated seller soundex code"
	egen buyerex		=	soundex(lbuyernonum)
	la var buyerex "Unabbreviated buyer soundex code"

	bysort property_id (selldate obnum): replace include = 0 if sellid == sellid[_n+1] | buyerex == buyerex[_n+1] | buyerex == sellerex  // do not include if same seller/buyer appears twice in a row or buyer and seller are the same
...
///////////////////////////////////////////
{
	...
	pause "Check missing/nonmissing developer ID observations"
}
/////////////////////////////////
...
////////////////////
{
	...
	tab numunits if `b1'
	drop `b1'
	pause "Check number of units statistics"
...
}
{
	...
	qui drop `p1'
	pause "Check included properties"
}
//////////////////////////////////
...
{
	sort zipcode
	merge m:1 zipcode using ${datdir}geo/lacensuszip.dta
	tab _merge
	drop if _merge==2
	drop _merge
}
...
////////////////////////////////////////////////////
{
	sort sellyear
	gen lp	 						= 	log(price)
	gen loghhinc1990 				= 	log(medhhinc1990)
	gen loghhinc2000				=	log(medhhinc2000)
...
/////////////////////////////////////////
{
	bysort bid (selldate obnum): gen timesell = sdate[_n]-sdate[1]
